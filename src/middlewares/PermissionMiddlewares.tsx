        ...
        return (
            <Container maxWidth='sm' sx={{mt:16}}>
                <Box textAlign='center'>
                    <img src="/static/images/status/500.svg" alt="status-500" height={260} />
                </Box>
                ...
                <Typography color='text.secondary' sx={{mb: 4}}>
                    Se você solicitou para a adminstração, a permissão para acessar essa área, clique no botão abaixo e atualize a página!
                </Typography>
